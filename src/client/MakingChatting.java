...
public class MakingChatting extends JFrame implements MouseListener {
	JTable jTable;
	...
	public void mouseClicked(MouseEvent me) {
		...
		int result = JOptionPane.showOptionDialog(null, "초대하시겠습니까?", "초대", JOptionPane.YES_NO_CANCEL_OPTION, JOptionPane.QUESTION_MESSAGE, null, buttons, "두번째값");
		if (result == 0) {
			// 친구초대
		} else if (result == 1) {
			dispose();
	...
	public MakingChatting() {
		JFrame frame = new JFrame();
		JPanel friend = new JPanel();
		
	    JLabel friend2 = new JLabel("채팅생성");
	...
	public static void main(String[] args) {
	      MakingChatting main = new MakingChatting();
	}
}
